...
import com.tahir.batch.load.users.service.base.BatchLoadUsersLocalServiceBaseImpl;
 ...
 */
@Component(
	property = "model.class.name=com.tahir.batch.load.users.model.BatchLoadUsers",
	service = AopService.class
)
public class BatchLoadUsersLocalServiceImpl
	extends BatchLoadUsersLocalServiceBaseImpl {
	
	public String loadUsers() {
		InputStream is = BatchLoadUsersLocalServiceImpl.class.getClassLoader().getResourceAsStream("userloadtest.json");
		...
		/*
		 * try { ImportTask response = importTaskResource.postImportTask(
		 * String.valueOf("com.liferay.headless.admin.user.dto.v1_0.UserAccount"), null,
		 * "INSERT", null, null, "IMPORT_STRATEGY_ON_ERROR_CONTINUE", null, usersJson);
		 * System.out.println(response); return response.toString(); } catch (Exception
